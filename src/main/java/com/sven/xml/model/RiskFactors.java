 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{}risk-factor" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "risk-factors")
public class RiskFactors {

    @XmlElement(name = "risk-factor")
    protected List<RiskFactor> riskFactor;
    ...
    public List<RiskFactor> getRiskFactor() {
        if (riskFactor == null) {
            riskFactor = new ArrayList<RiskFactor>();
        }
