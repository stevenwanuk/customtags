 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{}complication" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "complications")
public class Complications {

    protected List<Complication> complication;
    ...
    public List<Complication> getComplication() {
        if (complication == null) {
            complication = new ArrayList<Complication>();
        }
